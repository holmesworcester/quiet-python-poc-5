...
def register_queries():
    ...
    try:
        from . import queries_system
        query_registry.register('system.dump_database', queries_system.dump_database)
        query_registry.register('system.logs', queries_system.get_logs)
    except ImportError as e:
        print(f"Failed to load system queries: {e}")
