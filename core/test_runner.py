...
class TestRunner:
    ...
    def run_handler_test(self, test, handler_file, handler_name=None, command_name=None):
        ...
        if "params" in test.get("given", {}):
            ...
            # Skip idempotency check for create/join/process_incoming commands as they are inherently non-idempotent
            skip_idempotency = (command_name in ['create', 'join', 'process_incoming'])
            idempo_failed = False
