"""
Helper module for blocking functionality that can be imported from projectors.
"""
import json
...
def unblock(db, event_id):
    ...
    for event_id, event_type, data_json, metadata_json in blocked_events:
        try:
            ...
            # Use 'payload' to match what projectors expect
    ...
    try:
        cursor.execute(
            ...
            (
                ...
                blocked_by_id,
                event_type,
                json.dumps(data),  # This will be the payload data
